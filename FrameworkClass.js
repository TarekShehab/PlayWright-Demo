...
let CreatIssueLibrary = require('./MethodsLib/CreateIssuePageMethods');
let ProjectSettingsLibrary = require('./MethodsLib/ProjectSettingsPageMethods');
let IssueProperitiesLibrary = require('./MethodsLib/IssueProperitiesMethods');
...
class Iteration extends BaseClass {
    ...
    async Login() {
        ...
        this.StartTransaction("Navigation to to the application dashboard")
        await this.KeepPage.waitForNavigation();  
        await this.delay(10000)

        await this.KeepPage.waitForSelector('text=Kanban board', {timeout: 100000},{visible: true}); 
